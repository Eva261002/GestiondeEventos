    ...
    <header class="py-4 shadow-md bg-gray-800 rounded">
        <nav class="container mx-auto flex justify-between items-center">
            <ul class="flex space-x-4">
                <li><a href="index.php" class="text-white hover:bg-yellow-500 transition duration-300 px-3 py-2 rounded">Inicio</a></li>
                <li><a href="registro.php" class="text-white hover:bg-yellow-500 transition duration-300 px-3 py-2 rounded">Registrarse</a></li>
                <li><a href="inicio_sesion.php" class="text-white hover:bg-yellow-500 transition duration-300 px-3 py-2 rounded">Iniciar Sesión</a></li>
            </ul>
        </nav>
    </header>
    <main class="container mx-auto mt-10 text-center">
        <h2 class="text-4xl font-bold text-gray-800 mb-4">Registro</h2>
        <form method="POST" action="registro.php" enctype="multipart/form-data" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 max-w-sm mx-auto">
            ...
            <button type="submit" class="bg-gradient-to-r from-blue-600 to-blue-500 text-white hover:bg-orange-700 transition duration-300 px-4 py-2 rounded shadow-lg">Registrarse</button>
        </form>
    </main>
